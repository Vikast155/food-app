        ...
        <Row className='align-items-center'>
          <Col lg={6} className='text-center text-lg-start mb-5 mb-lg-0'>
           ...
           dolor primis libero tempus, blandit varius
             ...
             <Link to="/">
              <img 
              src={StoreIOS} alt="Ios" className='store img-fluid  me-3'/>
             </Link>
             <Link to="/">
              <img 
              src={StoreGoogle} alt="Android" className='store img-fluid  me-3'/>
             </Link>
          </Col>
          <Col lg={6}> 
           <img 
           src={DownloadImage} alt="e_shop"className='img-fluid' />
          </Col>
        </Row>
      </Container>
    </section>
